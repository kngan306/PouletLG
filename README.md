...
![Membership](screenshots/user-membership.png)  

**User Account – Wishlist**  
![Wishlist](screenshots/user-wishlist.png)  

**User Account – Addresses**  
![Addresses](screenshots/user-address.png)  

**Product Review**  
![Product Review](screenshots/product-review.png)  

**Contests**  
![Contest 1](screenshots/contest1.png)  
![Contest 2](screenshots/contest2.png)  
...
**Category Management**  
![Category Management](screenshots/admin-category.png)  

**Product Management**  
![Product Management](screenshots/admin-product.png)  

**Promotion Management**  
![Promotion Management](screenshots/admin-promotion.png)  

**Order Management**  
![Order Management](screenshots/admin-order.png)  

**Review Management**  
![Review Management](screenshots/admin-review.png)  

**User Management**  
![User Management 1](screenshots/admin-users1.png)  
![User Management 2](screenshots/admin-users2.png)  

**Banner Management**  
![Banner Management](screenshots/admin-banner.png)  

**Contact Page Management**  
![Contact Management](screenshots/admin-contact.png)  

**About Page Management**  
![About Management](screenshots/admin-about.png)  

**Contest Management**  
![Contest Management](screenshots/admin-contest.png)  

**Community Management**  
![Community Management](screenshots/admin-community.png)  

### 🔐 Authentication & Authorization

![Login](screenshots/login.png)  
![Register](screenshots/register.png)  
![Forgot Password 1](screenshots/forgot-password1.png)  
